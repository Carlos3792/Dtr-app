 ...
 * @author carlos
 */
public class PantallaModificarOrdenConDomicilio extends javax.swing.JFrame implements ActionListener{
    //Atributos
    int id;
    //Creacion del modelo.
    ...
    //
    PanelOrdenConDomicilio pantalla;
    
    
    /**
     * Creates new form PantallaModificarOrdenConDomicilio
     */
    public PantallaModificarOrdenConDomicilio() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Modificar orden con domicilio");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PantallaModificarOrdenConDomicilio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PantallaModificarOrdenConDomicilio().setVisible(true);
            }
        });
    }
    ...
    public PanelOrdenConDomicilio getPantalla() {
        return pantalla;
    }

    public void setPantalla(PanelOrdenConDomicilio pantalla) {
